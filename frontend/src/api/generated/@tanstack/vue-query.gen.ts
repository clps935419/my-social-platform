...
): QueryKey<Options<ListPostsData>> => [createQueryKey('listPosts', options, true)];
...
export const listPostsInfiniteOptions = (options?: Options<ListPostsData>) => {
  return infiniteQueryOptions<
    ...
    number | Pick<QueryKey<Options<ListPostsData>>[0], 'body' | 'headers' | 'path' | 'query'>
  >(
    // @ts-ignore
    {
...
export const listCommentsInfiniteQueryKey = (
  options: Options<ListCommentsData>
): QueryKey<Options<ListCommentsData>> => [createQueryKey('listComments', options, true)];

export const listCommentsInfiniteOptions = (options: Options<ListCommentsData>) => {
  return infiniteQueryOptions<
    ListCommentsResponse,
    AxiosError<DefaultError>,
    InfiniteData<ListCommentsResponse>,
    QueryKey<Options<ListCommentsData>>,
    number | Pick<QueryKey<Options<ListCommentsData>>[0], 'body' | 'headers' | 'path' | 'query'>
  >(
    // @ts-ignore
    {
      queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<
          QueryKey<Options<ListCommentsData>>[0],
          'body' | 'headers' | 'path' | 'query'
        > =
          typeof pageParam === 'object'
            ? pageParam
